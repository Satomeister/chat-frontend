...
const UploadImageButton:FC<UploadIMageButtonProps> = ({onInputChange}):JSX.Element => {
  ...
  return (
    <div>
      <input onChange={onChangeInput} ref={inputRef} type="file" name="myImage" accept="image/*" hidden multiple />
